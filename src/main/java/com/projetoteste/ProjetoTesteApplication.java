    ...
    public void run(String... args) throws Exception {
        ...
        while (true) {
            ...
            if (opcao == 1) {
                ...
                System.out.println("Modelo: " + c.getModelo() + " | Montadora: " + c.getMontadora() + " | Ano: " + c.getAno() + " | Alteração Concluída!!");
                ...
                // acessando o carro que vai ser deletado
                System.out.println("Digite o id do carro que você quer deletar: ");
                long id = Integer.parseInt(teclado.nextLine());
                Carro c = carroRepositorio.findById(id).get();

                // deletando no banco
                System.out.println("Modelo: " + c.getModelo() + " | Montadora: " + c.getMontadora() + " | Ano: " + c.getAno() + " | Deletado!!");
                carroRepositorio.delete(c);
            }
            else if (opcao == 5) {
